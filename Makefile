...
SVC_OBJS =      \
        ...
        $(OBJDIR)/ModbusConn.o \
        $(OBJDIR)/main.o \
        $(OBJDIR)/core_src/BufferHolder.o \
        $(OBJDIR)/core_src/LogicalDevice.o \
        $(OBJDIR)/core_src/Module.o \
        $(OBJDIR)/core_src/PhysValueTransformer.o \
        $(OBJDIR)/core_src/Configurator.o \
        $(OBJDIR)/core_src/WagoDevice.o \
        $(OBJDIR)/core_src/ModuleDB.o \
        $(OBJDIR)/core_src/Services.o \
        $(OBJDIR)/core_src/Tools.o \
        $(ADDITIONAL_OBJS) 
